...
// const randonCityNames = ['Lucknow', 'Delhi', 'Agra', 'Mumbai','Phagwara', 'Chennai', 'Pune', 'Jalandhar', 'Jaipur', 'Kanpur', 'Indore', 'Ludhiana','Amritsar'];
// var c="";
// const [changeName, setChageName]=useState("CITY NAME - LUCKNOW");
// setInterval(() => {
//    var min = 1;
//    var max = randonCityNames.length-1;
//    var rand =  (Math.random() * (max-min));
//    var finalNo = Math.round(rand);
//    c = randonCityNames[finalNo];
//    setChageName("City name - " + c);
// }, 3000);
